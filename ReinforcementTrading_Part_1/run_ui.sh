...
pkill -f "streamlit.*trading_bot/ui/app.py" >/dev/null 2>&1 || true

python -m streamlit run trading_bot/ui/app.py --server.headless true --server.address localhost --server.port 8501
